...
document.addEventListener('DOMContentLoaded', () => {
  ...
  /* ---------------- TESTIMONIALS DATA ---------------- */
  const TESTIMONIALS = [
    ['Sports Camp Infra transformed our preschool playground with 30mm EPDM safety flooring. Parents love the soft feel and colorful hopscotch graphics!', 'Meera Kapoor', 'Preschool', 'https://images.unsplash.com/photo-1580489944761-15a19d654956?q=80&w=200&auto=format&fit=crop'],
    ['Zero playground injuries reported since replacing hard tiles with cushioned EPDM safety flooring. Superb quality and quick execution!', 'Rajesh Sharma', 'Valley Township', 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?q=80&w=200&auto=format&fit=crop'],
    ['The soft play turf and rubber wetpour combo in our club kids zone looks world-class. Drains instantly after monsoon rains!', 'Sunil Nair', 'Resort', 'https://images.unsplash.com/photo-1633332755192-727a05c4013d?q=80&w=200&auto=format&fit=crop'],
  ];
